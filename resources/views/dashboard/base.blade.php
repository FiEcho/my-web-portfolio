...
<body>
    ...
    <section class="home-section">
        <div class="home-content">
            ...
            <button type="button"
                class="inline-block px-2 py-1.5 m-4 bg-gray-800 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-gray-900 hover:shadow-lg focus:bg-gray-900 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg transition duration-150 ease-in-out"><i
                    class='bx bx-menu text-white'></i></button>
